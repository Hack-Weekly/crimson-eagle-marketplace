...
const Product = ({product}) => {
  ...
  return (
<div>
    <div className="border border-[#f97316] h-[300px] mb-4 relative overflow-hidden group transition bg-white">
      <div className="w-full h-full flex justify-center items-center">{/*image*/}
    ...
    <div className="text-sm capitalize text-slate-100 mb-1">{category}</div>
    <Link to={`/product/${id}`}>
